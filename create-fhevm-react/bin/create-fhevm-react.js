...
if (!projectName) {
  ...
  console.log('  npx create-fhevm-react my-app');
  console.log('\nFor example:');
  console.log('  npx create-fhevm-react my-react-app');
  process.exit(1);
}

const currentDir = process.cwd();
const projectDir = path.join(currentDir, projectName);
const templateDir = path.join(__dirname, '../templates/react-template');
...
console.log(`Creating a new React FHEVM app in ${projectDir}`);
